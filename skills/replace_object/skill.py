...
使用 Canny ControlNet 保持结构，Inpaint 重绘替换区域
"""
...
class ReplaceObject:
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        logger.info(f"ReplaceObject 初始化完成")
    ...
    def _setup_config(self):
        defaults = {
            ...
            'default_prompt': 'new beautiful object, high quality, detailed, masterpiece',
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            if kwargs.get('output_path'):
                ...
                output_path = str(self.output_dir / f"{Path(image_path).stem}_replaced_{timestamp}.png")
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="替换物体工具")
