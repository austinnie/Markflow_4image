...
class ChangePerspective:
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        logger.info(f"ChangePerspective 初始化完成")
    ...
    def _generate_canny_image(self, image: Image.Image) -> Optional[Image.Image]:
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            control_image = self._generate_canny_image(image)
            ...
            if kwargs.get('output_path'):
                ...
                output_path = str(self.output_dir / f"{Path(image_path).stem}_perspective_{perspective}_{timestamp}.png")
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="改变视角工具")
