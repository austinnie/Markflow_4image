...
使用 Canny ControlNet 保持结构，Inpaint 填充移除区域
"""
...
class RemoveObject:
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        logger.info(f"RemoveObject 初始化完成")
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            if kwargs.get('output_path'):
                ...
                output_path = str(self.output_dir / f"{Path(image_path).stem}_removed_{timestamp}.png")
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="移除物体工具")
