...
"""
改变表情 Skill - 改变人物表情（微笑/生气/惊讶/悲伤等）
...
class ChangeExpression:
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        logger.info(f"ChangeExpression 初始化完成")
    ...
    def _generate_face_mask(self, image: Image.Image) -> Optional[Image.Image]:
        ...
        try:
            ...
            # 面部区域
            face_top = y_min
            face_bottom = y_min + int(body_h * 0.32)
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            if kwargs.get('output_path'):
                ...
                output_path = str(self.output_dir / f"{Path(image_path).stem}_expr_{expression}_{timestamp}.png")
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="改变表情工具")
