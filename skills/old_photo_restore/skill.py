...
使用 Canny ControlNet 保持结构，Inpaint 修复和上色
"""
...
class OldPhotoRestore:
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        logger.info(f"OldPhotoRestore 初始化完成")
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            if kwargs.get('output_path'):
                ...
                output_path = str(self.output_dir / f"{Path(image_path).stem}_restored_{style}_{timestamp}.png")
